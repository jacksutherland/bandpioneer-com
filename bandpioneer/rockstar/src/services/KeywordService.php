	...
	public static function getAIQuery($aiQueryType, $params = [])
	{
	    switch ($aiQueryType)
	    {
	        case AIQueries::KEYWORDS:
		        ...
		        return "Create {$total} SEO keywords that are common search terms a lot of people likely search for, that are related to the primary keyword ({$params['keyword']}). They should be a mix of short keywords and long-tail keywords. And some should be closely related to the primary keyword, some very different than the primary keyword, and some should be 'people also search for' keywords, to provide a range of options. Each keyword must be less than 50 characters and separated by a comma. Do NOT add numbers or bullets! The returned keywords should be words and spaces only, and delimited by commas.";
