	...
	public static function getAIQuery($aiQueryType, $params = [])
	{
	    switch ($aiQueryType)
	    {
	        case AIQueries::KEYWORDS:
		        ...
		        // return "Create {$total} long-tail SEO keywords related to the primary keyword '{$params['keyword']}'. These related keywords should be common search terms that a lot of people likely search for. {$qty} of them should be very similar to the primary keyword ({$params['keyword']}), {$qty} should only be slightly related to the primary keyword, and the remaining {$remainder} should be very different than the primary keyword. Each keyword must be less than 50 characters and separated by a comma. Do NOT add numbers or bullets! The returned keywords should be words and spaces only, and delimited by commas.";

		        return "Create {$total} long-tail SEO keywords related to the primary keyword 'how to bake a cake'";
